...
class ExpandaObstacle < Obstacle
	attr_accessor :rate
	def initialize(x,y,rate=0.1)
		super(x,y)
		@rate = rate
...
panda1 = SpinnyObstacle.new(100,50)
panda2 = ExpandaObstacle.new(150,50)
panda3 = WobblyObstacle.new(200,50,0.5)
